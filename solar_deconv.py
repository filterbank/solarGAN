...
if cuda:
    ...
    criterion_GAN.to(device=cuda)
    criterion_pixelwise.to(device=cuda)
...
def sample_images(batches_done):
    ...
    save_image(img_sample, 'images/%s/%s.png' % (opt.dataset_name, batches_done), nrow=2, normalize=True)
